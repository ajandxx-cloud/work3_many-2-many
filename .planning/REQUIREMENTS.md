...
- [ ] **EXP-03**: Baseline 1 — Door-to-door DARP (no meeting points)
- [ ] **EXP-04**: Baseline 2 — Single-sided meeting point (pickup flexible, dropoff fixed)
- [ ] **EXP-05**: Baseline 3 — Bidirectional meeting points, no passenger choice (system assigns directly)
- [ ] **EXP-06**: Full model — Bidirectional meeting points + passenger choice + rolling horizon
- [ ] **EXP-07**: Ablation 1 — Remove rolling horizon (myopic insertion only)
- [ ] **EXP-08**: Ablation 2 — Remove passenger choice (system assigns best option directly)
