...
The ratio corresponds to approximately 50 requests per vehicle per peak hour;
for full-day planning, operators should scale based on hourly demand patterns
rather than applying the ratio directly to daily totals.
