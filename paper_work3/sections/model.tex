...
We model passenger choice using a binary logit model (special case of MNL when $|\text{choice set}| = 2$). For request $r$ of
...
\end{equation}
This near-zero acceptance probability (0.091\%) illustrates why the pre-filtering
step in the online algorithm is critical: under the $U_0 = 0$ normalization, any
...
The coupling between Layer~1 and Layer~2 follows a \emph{pre-filter-then-route} design
