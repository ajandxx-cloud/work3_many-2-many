...
per-trip vehicle utilization at equal served share (FullModel 11.1 vs.\
...
minimum fleet ratio of 15 vehicles per 100 peak-hour requests is needed to avoid severe
service degradation.
