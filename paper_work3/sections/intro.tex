...
Passenger response is modeled via a binary logit model (special case of MNL) with three
...
\begin{enumerate}
  ...
  \item Empirical demonstration of a \textbf{35.0\%} vehicle efficiency gain in
        ...
        and a 29.1\% gain under the unconstrained comparison (15.1 vs.\ 21.3\,vkm/trip).
