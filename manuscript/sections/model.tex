...
For post-hoc policy evaluation, we define a social welfare metric that includes a
...
\emph{not} influence the routing objective (Equation~\ref{eq:objective}), the bundle
selection, or the binary logit acceptance probability. The separation ensures that
operational decisions are consistent across different policy preferences encoded
through $\Gamma$.
...
\footnote{%
  ...
  revealed-preference data from Chinese DRT users would likely yield lower walking
