...
\end{equation}
$\Gamma$ enters only the ex-post welfare accounting discussed in Section~\ref{sec:experiments}; it does
...
heterogeneity; they are not empirical demographic groups or field equity validation.
...
\footnotesize
\begin{tabular}{p{0.22\textwidth}lp{0.23\textwidth}p{0.25\textwidth}l}
\toprule
