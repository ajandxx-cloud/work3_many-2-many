...
passenger-type trade-offs. The full passenger-response-aware design is therefore not an
unconditional substitute for door-to-door service. It is an operational design option whose
